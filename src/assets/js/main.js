...
function sitePlusMinus(){
  ...
  function createBindings(quantityContainer) {
    var quantityAmount =
      quantityContainer.getElementsByClassName("quantity-amount")[0];
    var increase = quantityContainer.getElementsByClassName("increase")[0];
    var decrease = quantityContainer.getElementsByClassName("reduced")[0];
    if (increase) {
...
var cartProducts = document.querySelectorAll(".product");
...
function handleCart() {
  ...
  subTotal.textContent =
    totalPriceProduct > 0 ? formatMoney(totalPriceProduct) + "đ" : "";
}
handleCart();
...
const navItems = document.querySelectorAll(".menu_nav .nav-item");
